                    ...
                    <form action="{{ route('schedules.update', $schedule->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $schedule->time_in }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="course_id"
                                    ...
                                    @foreach ($course as $cs)
                                        <option value="{{ $cs->id }} " {{ $cs->id == $schedule->course_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="groupClass_id"
                                    ...
                                    @foreach ($groupClass as $gc)
                                        <option value="{{ $gc->id }}" {{ $gc->id == $schedule->groupClass_id ? 'selected' : '' }}>
                                            {{ $gc->name }}</option>
                                    @endforeach
                                </select>
                                @error('groupClass_id')
