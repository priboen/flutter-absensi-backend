    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Presensi Mata Kuliah</h1>
            ...
            <div class="section-body">
                ...
                <div class="row mt-sm-4">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form
                                action="{{ route('attendance-schedules.update', ['attendance_schedule' => $schedule->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="form-group col-md-6 col-1">
                                            ...
                                            <select name="course_id"
                                                ...
                                                @foreach ($course as $cs)
                                                    <option value="{{ $cs->id }}"
                                                        {{ isset($schedule) && $cs->id == $schedule->course_id ? 'selected' : '' }}>
                                                        {{ $cs->courses_code }} - {{ $cs->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('course_id')
                                        ...
                                        <div class="form-group col-md-6 col-1">
                                            ...
                                            <select name="groupClass_id"
                                                ...
                                                @foreach ($groupClass as $gc)
                                                    <option value="{{ $gc->id }}"
                                                        {{ $gc->id == $schedule->groupClass_id ? 'selected' : '' }}>
                                                        {{ $gc->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                @enderror"
                                    ...
                                    is-invalid
                                @enderror"
                                                name="time_end" value="{{ $schedule->time_end }}">
                                            @error('time_end')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
