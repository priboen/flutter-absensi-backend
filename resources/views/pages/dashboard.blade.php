                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="text-small text-muted">Telah melakukan presensi datang pada mata kuliah
                                            A.</span>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="text-small text-muted">Telah melakukan presensi pulang pada mata kuliah
                                            B.</span>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="text-small text-muted">Telah melakukan presensi datang pada mata
                                            kuliah
                                            B.</span>
                                    </div>
                                </li>
